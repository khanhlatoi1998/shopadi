        ...
        <div className="py-6 border-y border-solid border-color_07">
            <div className="flex items-center justify-between">
                ...
                <form className="flex items-center gap-4">
                        ...
                        <select name="" id="" className="border text-size-0 border-solid py-2 pl-1 min-w-[100px] rounded border-color_07">
                            <option value="">Default</option>
                            <option value="">2</option>
                            <option value="">3</option>
                        </select>
                        <label htmlFor="">Show:</label>
                        <select name="" id="" className="border text-size-0 border-solid py-2 pl-1 rounded min-w-[50px] border-color_07">
